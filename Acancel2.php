...
<div id="middlePart">
<div id="rt">
<h2 id="hh">Ticket Cancel Update</h2> 
<?php
...
$sql="update bkbus set status='CANCELLED' where pnr=$aa";

$result=mysql_query($sql,$con); 
	echo "<h3> Bus Ticket Cancellation done</h3>";
	echo "<a href='Ahome.php'> Go Dashboard</a>";
	

$sql2="update Cancel_history set remark='APPROVE' where pnr='$aa'";
$result2=mysql_query($sql2,$con);

$sql4="UPDATE Cancel_history SET cancel_approve_date = CURRENT_TIMESTAMP where pnr=$aa";
